...
UserSettingsViewModel::UserSettingsViewModel(QObject *parent) : QObject(parent)
{
    ...
    QVector<UserSettingsItem> userInfoItems {{"First Name", UserSettingsItem::SettingType::Value},{"Last Name", UserSettingsItem::SettingType::Value},{"BSH Email", UserSettingsItem::SettingType::Value}};
    ...
    QVector<UserSettingsItem> projectInfoItems {{"Full Name", UserSettingsItem::SettingType::Value},{"Short Name", UserSettingsItem::SettingType::Value},{"GitHub Repo", UserSettingsItem::SettingType::Value},{"Jira Project", UserSettingsItem::SettingType::Value}};
